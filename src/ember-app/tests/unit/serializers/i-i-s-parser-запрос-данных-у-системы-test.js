...
moduleForModel('i-i-s-parser-запрос-данных-у-системы', 'Unit | Serializer | i-i-s-parser-запрос-данных-у-системы', {
  // Specify the other units that are required for this test.
  needs: [
    'serializer:i-i-s-parser-запрос-данных-у-системы',
    'service:syncer',
    'transform:file',
    'transform:decimal',
    'transform:guid',
