...
moduleForModel('i-i-s-parser-соответствие-стройматериала-и-производителя', 'Unit | Serializer | i-i-s-parser-соответствие-стройматериала-и-производителя', {
  // Specify the other units that are required for this test.
  needs: [
    'serializer:i-i-s-parser-соответствие-стройматериала-и-производителя',
    'service:syncer',
    'transform:file',
    'transform:decimal',
    'transform:guid',
